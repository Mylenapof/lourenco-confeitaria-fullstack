...
import com.lourenco.backend.config.FileStorageProperties;
    ...
    public String storeFile(MultipartFile file) {
        ...
        try {
            ...
            if (fileName.contains("..")) {
                throw new RuntimeException("Nome do arquivo contém sequência de caminho inválida: " + fileName);
            }

            // Copia arquivo para o local de destino
