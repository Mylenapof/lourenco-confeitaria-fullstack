...
export const routes: Routes = [
  ...
  },
  {
    path: 'produto/:id',
    loadComponent: () =>
      import('./pages/produto-detalhes/produto-detalhes.component')
        .then((m) => m.ProdutoDetalhesComponent),
  },
  {
    path: 'encomendas', // Tela pública de solicitar encomenda
    loadComponent: () =>
      import('./pages/encomendas/encomendas.component').then((m) => m.EncomendasComponent),
  },
  {
    path: 'contato',
    loadComponent: () =>
  ...
  {
    path: 'admin',
    canActivate: [authGuard],        // Protege /admin
    canActivateChild: [authGuard],   // Protege TODAS as rotas filhas
    data: { requireAdmin: true },    // Exige ADMIN
    children: [
      {
        path: '',
      ...
      },
      {
        path: 'produtos',
        loadComponent: () =>
          import('./pages/admin/produtos/produtos.component')
            .then((m) => m.ProdutosComponent),
      },
      {
        path: 'produtos/novo',
        loadComponent: () =>
          import('./pages/admin/produto-form/produto-form.component')
      ...
      },
      {
        path: 'pedidos',
        loadComponent: () =>
          import('./pages/admin/pedidos/pedidos.component')
            .then((m) => m.PedidosComponent),
      },
      {
        path: 'encomendas',
        loadComponent: () =>
          import('./pages/admin/encomendas-admin/encomendas-admin.component')
            .then((m) => m.EncomendasAdminComponent),
      },
      {
        path: 'relatorios',
        loadComponent: () =>
          import('./pages/admin/relatorios/relatorios.component')
